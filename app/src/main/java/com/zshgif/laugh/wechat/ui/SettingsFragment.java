...
import com.zshgif.laugh.wechat.DemoModel;
...
//				RedPacketUtil.startChangeActivity(getActivity());
		...
		case R.id.btn_logout: //退出登陆
			logout();
			break;
		case R.id.ll_black_list://黑名单
//			startActivity(new Intent(getActivity(), BlacklistActivity.class));
			break;
		case R.id.ll_diagnose://诊断
//			startActivity(new Intent(getActivity(), DiagnoseActivity.class));
			break;
		case R.id.ll_set_push_nick://iOS离线推送昵称
...
//        if(((MyActivity)getActivity()).isConflict){
//        	outState.putBoolean("isConflict", true);
//        }else if(((MyActivity)getActivity()).getCurrentAccountRemoved()){
