package com.zshgif.laugh.wechat.db;
...
import com.zshgif.laugh.wechat.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(ContextUtil.getInstance().getApplicationContext());
    }
